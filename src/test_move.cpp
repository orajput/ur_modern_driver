...
public:
  ...
  */
  control_msgs::FollowJointTrajectoryGoal simpleTrajectory(double joint_move_dist, double traj_time)
  {
    ...
    double joint_offset[2] = {0.0, joint_move_dist};
    // Trajectory points
...
int main(int argc, char** argv)
{
  ...
  while (ros::ok())
  {
    ...
    arm.startTrajectory(arm.simpleTrajectory(joint_move_dist, traj_time));
    ...
    joint_move_dist = joint_move_dist * -1;
  }
  return 0;
}
